...
public class Logger {
    ...
    @Pointcut("within(com.book.controller.BookController*)")
    ...
    @Pointcut("execution(* com.book.controller.BookController.updateBook(..))")
    ...
    @Pointcut("execution(* com.book.controller.BookController.payBook(..))")
